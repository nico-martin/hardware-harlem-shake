  ...
  return (
    <footer className={cn(className, styles.root)}>
      ...
      <span className={styles.version}>
        <a
          href="https://github.com/nico-martin/scroll-hat-matrix-ui"
          target="_blank"
        >
          WebBluetooth Scroll Hat Matrix
        </a>{' '}
        v{pkg.version}
      </span>
      <button
      ...
      {infos && (
        <PortalBox
          ...
          title="WebBluetooth Scroll Hat Matrix"
        >
          <div className={styles.info}>
            <p>
              <b>WebBluetooth Scroll Hat Matrix</b> is a web-based UI to control
              a "Scroll Hat Matrix" over WebBluetooth by{' '}
